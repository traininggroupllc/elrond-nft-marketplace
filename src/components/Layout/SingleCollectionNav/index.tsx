...
const SingleCollectionNav = () => {
  ...
  return (
    <BsNavbar className='collection_nav flex-column px-4'>
      <div
        className={`collection_nav__details ${
          menuOpen && 'collection_nav__detailsOpen'
        }`}
      >
        {searchOpen ? (
          <Nav className='collection_navBar__search'>
            <NavItem>
          ...
          <Nav className='collection_navBar container-xl'>
            <NavItem>
              <Link
                className='navBar__link'
                to={isLoggedIn ? routeNames.dashboard : routeNames.home}
              >
                <ElrondLogo className='collection_navBar__logo' />
              </Link>
            </NavItem>
...
export default SingleCollectionNav;
